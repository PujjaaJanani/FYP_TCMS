...
Route::middleware('auth:sanctum')->group(function () {
    Route::middleware('ability:authority,admin,staff,student,parent')->group(function () {
        ...
        Route::get('/study-materials/{id}', [StudyMaterialController::class, 'getMaterial'])
            ->whereNumber('id');
        Route::get('/payments/verify/{paymentId}', [PaymentController::class, 'verifyPaymentStatus']);
    ...
    Route::middleware('ability:authority,admin,staff')->group(function () {
    ...
    Route::middleware('ability:student,parent')->group(function () {
        Route::get('/payments/student', [PaymentController::class, 'getStudentPayments']);
        Route::get('/payments/monthly-fee', [PaymentController::class, 'getMonthlyFee']);
    ...
    Route::prefix('parent/dashboard')->middleware('ability:parent')->group(function () {
